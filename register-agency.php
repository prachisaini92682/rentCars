<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
       include('./dbconnect.php');
        ...
        //check agency account is already exits or not
        $existSql = "SELECT * FROM `agency_acc` WHERE `email` = '$email'";
        ...
        if($email=='' || $password==''){
            ...
            $sql = "INSERT INTO `agency_acc` ( `email`, `password`,`contact`, `created_on`) VALUES ( '$email', '$hash','$contact', current_timestamp());";
...
<body class="bg-light">
    ...
    <div class="container bg-white text-dark p-4 mt-5 col-md-6" style="border-radius: 15px; ">
        <h1 class="text-center">Agency Register</h1>
        <form action="#" method="POST">
            ...
            <div class="mt-4">
                ...
                <span class="ml-2 px-3">Already registered? <a href="./login-agency.php" class="text-primary" style="text-decoration: underline;">Log In</a></p>
            </div>
        </form>
    </div>
